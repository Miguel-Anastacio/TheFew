...
void UPlaneHUD::NativeOnInitialized()
{
	...
	this->OnVisibilityChanged.AddDynamic(this, &UPlaneHUD::SetCrosshairVisiility);
...
void UPlaneHUD::SetCrosshairVisiility(ESlateVisibility state)
{
	CrosshairWidget->SetVisibility(state);
}
